...
![preview](https://raw.githubusercontent.com/shahsagarm/harinath.dev/main/thumbnail.png)
...
```bash
$ git clone https://github.com/shahsagarm/harinath.dev.git
$ cd harinath.dev
$ npm install
$ npm run dev
```
...
Licensed under the [MIT license](https://github.com/shahsagarm/harinath.dev/blob/main/LICENSE).

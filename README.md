...
```bash
$ git clone https://github.com/rasiganhari/harinath.portfolio.git
$ cd harinath.portfolio
$ npm install
$ npm run dev
```
...
Licensed under the [MIT license](https://github.com/rasiganhari/harinath.portfolio/blob/main/LICENSE).
